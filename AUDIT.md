...
- Current official standings and the Wikipedia roster disagree on Ricky
  Taylor. Full refresh rejects this inconsistency; it must not invent points
  or remove the validation. Live timing remains independently refreshable.
